...
namespace openaprs {
  ...
  Serialize::Serialize(const string &varMe) {
    _var.clear();
  ...
  Serialize &Serialize::operator=(const string &varMe) {
    _var.clear();
  ...
  const Serialize::varSizeType Serialize::Parse(const string &varMe) {
    bool isEscaped;
    string field, parseMe;
    size_t pos;
  ...
  const bool Serialize::add(const string &field) {
    if (field.length() < 1)
      return false;
  ...
  const string Serialize::operator[](const varSizeType w) {
    return getFieldAtIndex(w);
  } // Serialize::operator[]

  const string Serialize::getFieldAtIndex(const varSizeType w) {
    if (w > _var.size()-1)
      return string("");
  ...
  const string Serialize::compile() {
    stringstream s;
  ...
  const string Serialize::Escape(const string &parseMe) {
    string ret;
    size_t pos;
  ...
  const string Serialize::Urlencode(const string &parseMe) {
    stringstream s;
    size_t pos;
  ...
  const string Serialize::Urldecode(const string &parseMe) {
  ...
  char Serialize::hex2char(const string &hexNumber) {
    char *stop;
  ...
  const string Serialize::Unescape(const string &parseMe) {
    bool isEscaped = false;
    string ret = "";
    size_t pos;
  ...
  const string Serialize::char2hex(const char dec) {
