 ...
 **************************************************************************
 $Id: dccREMOVEMODULE.cpp,v 1.1 2005/11/21 18:16:04 omni Exp $
 **************************************************************************/
...
using namespace openaprs;
  ...
  const int dccREMOVEMODULE::Execute(COMMAND_ARGUMENTS) {
    ...
    app->Module(name, ModuleAction::remove);

    return CMDERR_SUCCESS;
  } // dccREMOVEMODULE::Execute
} // namespace dcc
